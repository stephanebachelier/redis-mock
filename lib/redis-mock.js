...
RedisClient.prototype.expireat = RedisClient.prototype.EXPIREAT = function (key, timestamp, callback) {

  keyfunctions.expireat.call(this, MockInstance, key, timestamp, callback);
};

RedisClient.prototype.pexpireat = RedisClient.prototype.PEXPIREAT = function (key, timestamp, callback) {

  keyfunctions.pexpireat.call(this, MockInstance, key, timestamp, callback);
};
